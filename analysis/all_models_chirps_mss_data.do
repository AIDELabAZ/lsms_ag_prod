...
* does
	* runs all models using:
		* same as main 
		* we use other dataset: we left missing values as missing and /// 
		only impute top 5%
...
* save for merge 
	*save 		"$export1/dta_files_merge/hh_included_mss.dta", replace
...
* save for image 
	graph 		export 	"$export1/figures/coefficients_plot_mss.pdf", as(pdf) replace

		saasasasas
* regression table 
	esttab 		model1 model2 model3 model4 model5 model6 /// 
				using "$export1/tables/reg_results_mss.tex", /// 
