...
* we include farm size 
	...
	global 		inputs_cp ln_total_labor_days ln_seed_value_cp  ln_fert_value_cp hh_asset_index ag_asset_index plot_area_GPS
...
* drop Mali bc hh and managers cannot be tracked 
	...
	svyset 		ea_id_obs [pweight=pw], strata(strata) singleunit(centered) /// 
				...
				urban plot_owned hh_asset_index ag_asset_index plot_area_GPS /// 
