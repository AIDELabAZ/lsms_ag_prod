...
* merge in livestock data
	...
	*** matched 6,741
	*** 26 unmatched from master
	
	drop 			if _sec6 == 2
	*** 286 dropped - want to keep households w/o livestock
