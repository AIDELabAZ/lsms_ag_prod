...
* does
	* merges weather data into unps2 household data
	* does this for north and south seperately
	* outputs complete wave 2 plot-crop data for building panel
...
* define paths
	...
	global  rooth 		"$data/lsms_ag_prod_data/refined_data/uganda/wave_2"
	global  export 		"$data/lsms_ag_prod_data/merged_data/uganda/wave_2"
...
* loop through each file in the above local
	...
	* merge weather data with household data
		...
		* define file naming criteriacriteria
			loc 		sat = substr("`file'", 8, 5)			
...
* save file
	save 		"$export/unps2_merged.dta", replace

* erase northern and southern files
	erase		"$export/unps2_merged_n.dta"
	erase		"$export/unps2_merged_s.dta"
